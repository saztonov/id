...
describe('общий документ о качестве (S53)', () => {
  it('форма без номера и без предмета опознаётся видом «quality_doc»', () => {
    // Заводской бланк отделки: заголовок «Документ о качестве» стоит отдельной
    // строкой, номера рядом нет. Лист оставался без вида, и шесть строк описи
    // «Документ о качестве № 99-32» не находили ничего.
