...
export const DOC_TYPES = [
  // ── Акты освидетельствования и приёмки ────────────────────────────────────
  {
    ...
    matchHints: {
      ...
      anchors: ['освидетельствовани[яе]\\s+скрытых\\s+работ'],
      bodyHints: [
    ...
    fieldSchema: [
      ...
      field('act_number', 'Номер акта', 'text', true, 'rule'),
      ...
      field('rep_developer_nrs', 'НРС представителя застройщика', 'text', false, 'rule'),
      field('rep_developer_order', 'Приказ представителя застройщика', 'text', true, 'rule'),
      field('rep_builder', 'Представитель лица, осуществляющего стр-во', 'text', true, 'llm'),
      field('rep_builder_order', 'Приказ представителя строительства', 'text', true, 'rule'),
      field('rep_builder_control', 'Представитель строительства по СК', 'text', true, 'llm'),
      field('rep_builder_control_nrs', 'НРС представителя по стройконтролю', 'text', false, 'rule'),
      field('rep_builder_control_order', 'Приказ представителя по СК', 'text', true, 'rule'),
      field('rep_designer', 'Представитель проектировщика, авторский надзор', 'text', false, 'llm'),
      field('rep_designer_order', 'Приказ представителя проектировщика', 'text', false, 'rule'),
      field('rep_contractor', 'Представитель лица, выполнившего работы', 'text', true, 'llm'),
      field('rep_contractor_order', 'Приказ представителя подрядчика', 'text', false, 'rule'),
      ...
      field('copies_count', 'Количество экземпляров акта', 'number', false, 'rule'),
  ...
  // ── Реестры и журналы ─────────────────────────────────────────────────────
  {
    ...
    matchHints: {
      ...
      anchors: ['Реестр\\s+приложений.{0,20}к\\s+акту'],
      bodyHints: [
