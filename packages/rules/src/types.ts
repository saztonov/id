...
export interface RevisionNode {
  ...
  /**
   * Месяц комплекта, `ГГГГ-ММ-01`.
   *
   * Свойство КОМПЛЕКТА, а не документа, и попало в граф именно поэтому: месяц
   * выбирает человек при заведении, а сойтись он обязан с датой акта внутри.
   * Проверить это можно только там, где видны обе величины сразу, — то есть в
   * графе, а не в форме заведения, где акта ещё нет.
   */
