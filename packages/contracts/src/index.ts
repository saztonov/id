...
/**
 * Разбор перечней акта (п. 3, п. 4): номера внутри строки, ссылка на реестр,
 * позиции материалов. Здесь, а не в API: те же строки читают сверка комплекта
 * и движок правил, а копии разбора уже расходились (см. заголовок `act-items.ts`).
 */
export * from './act-items.js';
/**
