...
export const IDS = {
  ...
  period: '2026-01-01',
  /**
   * Папки стенда. Идентификаторов работ и поданных в реестр комплектов здесь
   * больше нет: реестры сняты миграцией 0058, работы — 0059, и оставшиеся ключи
   * пережили бы модель, объясняя схему неправильно.
   */
  folderEmpty: '00000000-0000-4000-8000-000000000011',
  folderMarkup: '00000000-0000-4000-8000-000000000013',
  folderReview: '00000000-0000-4000-8000-000000000015',
  /**
   * Папка с ОПУБЛИКОВАННЫМ распознаванием: единственная, где живёт
   * «3. Проверить». Кнопка требует готового текста, и на остальных папках
   * стенда её нет вовсе.
   */
  folderRecheck: '00000000-0000-4000-8000-000000000017',
  ...
  /** Файлы ревизий: адресаты замены в строке списка (S27). */
  fileMarkup: '00000000-0000-4000-8000-000000000030',
  fileReview: '00000000-0000-4000-8000-000000000074',
} as const;
