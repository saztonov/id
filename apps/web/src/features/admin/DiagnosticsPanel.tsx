  ...
  return (
    <Space direction="vertical" size={16} style={{ width: '100%' }}>
      ...
      <Alert
        type="info"
        showIcon
        message="Ошибки, аномалии и скорость — в разделе «Журнал и качество»"
        description={
          'Здесь дежурная сводка: что происходит прямо сейчас. Ошибки с историей и разбором, ' +
          'всплески отказов по правам и лимитам, медленные запросы и SQL живут в соседнем ' +
          'разделе этой вкладки — «Журнал и качество». У них другой горизонт, чем у очереди задач.'
        }
      />
    </Space>
  );
