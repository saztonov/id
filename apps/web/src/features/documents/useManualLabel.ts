/**
 * Ручная метка страницы (§8.2, фаза 3) — общий хук двух экранов.
 *
 * Метку ставят с двух мест: из таблицы классификаций на вкладке «Документы» и с
 * панели типа страницы на экране разметки. Мутации, тексты уведомлений и
 * инвалидация кэша обязаны быть одними и теми же — иначе два экрана по-разному
 * сообщали бы об одном действии, а инвалидация, написанная по месту, разошлась
 * бы на одну букву ключа, и второй экран показывал бы старую метку.
 *
