...
describe('CROP_POLICY_VERSION', () => {
  it('версия политики зафиксирована', () => {
    ...
    //
    // v4 — страница рендерится в собственном разрешении (S46): скан в 200 dpi
    // больше не растягивается до 300, и модель видит другие пиксели.
    expect(CROP_POLICY_VERSION).toBe('crop.v4');
  });
});
