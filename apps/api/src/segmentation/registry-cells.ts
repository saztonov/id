 ...
 *
 * Цифра «6» вместо «б» и «п» вместо «н» — не опечатка подрядчика, а чтение:
 * в папке «ИД Мастер апрель 2026» распознавание отдаёт «6/н» и «6/п» на
 * четверти таких ячеек. Пока формы не совпадали, «6/н» считалось настоящим
 * номером, строка реестра искала документ «№ 6/Н» и не находила — то есть
 * ровно та же строка получала «нет в комплекте» вместо «сверить не с чем».
 */
const NO_NUMBER = /^[б6]\s*[/\\.]?\s*[нп]\.?$/iu;
