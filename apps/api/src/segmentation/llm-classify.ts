 ...
 */
import { normalizeLine } from '@id/doc-types';
 ...
 *
 * Повторяет `normalizeLine` из `@id/doc-types`, но посимвольно: та возвращает
 * готовую строку, а нам нужны ПОЗИЦИИ каждого уцелевшего символа в исходном
 * тексте. Без позиций цитату некуда отобразить, а `field_values.char_span`
...
/** Символы акцента, которые `normalizeLine` вычищает по всей строке. */
