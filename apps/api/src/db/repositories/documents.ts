 ...
 *
 * Drizzle 0.45 заворачивает отказ в `DrizzleQueryError`, а само имя нарушенного
 * ограничения лежит в `cause`. Проверка только верхнего уровня давала бы `null`
 * на КАЖДОМ отказе, то есть все ограничения превращались бы в 500 — молча.
 */
