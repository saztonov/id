-- Seed промптов стадии recognize (ADR-0007, план v3 Ф4/Ф5).
--
...
9. Return only one JSON object matching the response_format schema — no other output of any kind.$prompt$,
  $prompt${"type":"object","additionalProperties":false,"required":["fragments"],"properties":{"fragments":{"type":"array","items":{"anyOf":[{"type":"object","additionalProperties":false,"required":["kind","text","emphasis"],"properties":{"kind":{"type":"string","enum":["paragraph"]},"text":{"type":"string"},"emphasis":{"type":"string","enum":["none","strong"]}}},{"type":"object","additionalProperties":false,"required":["kind","level","text"],"properties":{"kind":{"type":"string","enum":["heading"]},"level":{"type":["integer","null"],"enum":[1,2,3,4,5,6,null]},"text":{"type":"string"}}},{"type":"object","additionalProperties":false,"required":["kind","title","header","rows"],"properties":{"kind":{"type":"string","enum":["table"]},"title":{"type":["string","null"]},"header":{"type":["array","null"],"items":{"type":"string"}},"rows":{"type":"array","items":{"type":"array","items":{"type":"string"}}}}}]}}}}$prompt$::jsonb,
  NULL
)
